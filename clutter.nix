...
, libXdamage, libXcomposite, libXi, cogl, pango, atk, json_glib, gdk_pixbuf, gtk3,
gobjectIntrospection, libinput, libxkbcommon, libgudev
  ...
  propagatedBuildInputs =
    [ libX11 mesa libXext libXfixes libXdamage libXcomposite libXi cogl pango
      atk json_glib gobjectIntrospection
            ...
            wayland wayland-protocols
            libxkbcommon libinput gdk_pixbuf gtk3
            libgudev
      ];
